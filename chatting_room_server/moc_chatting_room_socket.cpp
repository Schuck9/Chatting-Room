...
#include "../chatting_room_server/chatting_room_socket.h"
...
QT_MOC_LITERAL(12, 108, 18), // "signalDisConnected"
QT_MOC_LITERAL(13, 127, 14), // "SltSendMessage"
QT_MOC_LITERAL(14, 142, 15), // "SltDisconnected"
QT_MOC_LITERAL(15, 158, 12) // "SltReadyRead"

    },
    "chatting_room_socket\0signalMessage\0\0"
    "type\0name\0dataVal\0Id\0Id_to\0signalStatus\0"
    "state\0errorMessage\0errormessage\0"
    "signalDisConnected\0SltSendMessage\0"
    "SltDisconnected\0SltReadyRead"
};
...
void chatting_room_socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->signalDisConnected(); break;
        case 4: _t->SltSendMessage((*reinterpret_cast< const quint8(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QString(*)>(_a[3])),(*reinterpret_cast< const int(*)>(_a[4])),(*reinterpret_cast< const int(*)>(_a[5]))); break;
        ...
        {
            using _t = void (chatting_room_socket::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chatting_room_socket::signalDisConnected)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void chatting_room_socket::signalDisConnected()
{
